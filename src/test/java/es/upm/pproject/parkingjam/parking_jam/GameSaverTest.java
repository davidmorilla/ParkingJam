...
@DisplayName ("Tests related to testing the class GameSaver")
@Nested
class GameSaverTest {
	...
	@DisplayName ("Tests related to checking the creation and existence of output files")
	@Nested
	class FilesTests {
		@Test
	...
	@DisplayName ("Tests related to checking the saving of games")
	@Nested
	class SavingTests {
		...
		@Test
		void testSaveGameSaveScoreFromFile() throws IOException {
			List<Pair<Character, Pair<Integer, Character>>> history = new ArrayList<>();
			history.add(new Pair<>('c', new Pair<>(1, 'D')));
			history.add(new Pair<>('g', new Pair<>(1, 'L')));
			int totalScore = 100;
		...
		@Test
		void testSaveGameSaveBoardFromFile1() throws IOException {
			List<Pair<Character, Pair<Integer, Character>>> history = new ArrayList<>();
			history.add(new Pair<>('c', new Pair<>(1, 'D')));
			history.add(new Pair<>('g', new Pair<>(1, 'L')));
			int totalScore = 100;
		...
		@Test
		void testSaveGameSaveBoardFromFile() throws IOException {
			List<Pair<Character, Pair<Integer, Character>>> history = new ArrayList<>();
			history.add(new Pair<>('c', new Pair<>(1, 'D')));
			history.add(new Pair<>('g', new Pair<>(1, 'L')));
			int totalScore = 100;
	...
	@DisplayName ("Tests related to checking the loading of saved games")
	@Nested
	class LoadingTests {
		@Test
