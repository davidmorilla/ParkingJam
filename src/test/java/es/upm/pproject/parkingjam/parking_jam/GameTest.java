...
public class GameTest {
	...
	class GameLevelTests {
		...
		@Test
		void testResetOriginalLevel() throws IllegalExitsNumberException, IllegalCarDimensionException, NullBoardException, IllegalDirectionException, LevelAlreadyFinishedException, IllegalCarException, InvalidMovementException, MovementOutOfBoundariesException { 
			game = new Game(1);
			game.moveCar('e', 1, 'U');
			game.moveCar('g', 3, 'L');
			...
			assertArrayEquals(level1Board, game.getBoard());
		}
